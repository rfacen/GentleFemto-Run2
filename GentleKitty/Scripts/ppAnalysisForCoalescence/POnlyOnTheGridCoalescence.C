...
void FitPPVariations(const unsigned &NumIter, int imTBin, int system,
  ...
  std::cout << "The considered Range is kMin: " << kMin << " and kMax: " << kMax
      << std::endl;
  ...
  double PurityXi;
  std::vector<double> ProSecondary =
      { 0.82, 0.81, 0.81, 0.81, 0.81, 0.82, 0.83 };
  std::vector<double> LamPurity = { 0.92, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95 };
  std::vector<double> LamSecondary =
      { 0.76, 0.75, 0.75, 0.76, 0.76, 0.76, 0.77 };

  std::vector<float> mTValues = { 1.10765, 1.16831, 1.22838, 1.31558, 1.46282,
      1.68716, 2.21156 };
  ...
  const std::vector<double> lam_pp =
      { ppLam0.GetLambdaParam(CATSLambdaParam::Primary,
          ...
          ppLam3.GetLambdaParam(CATSLambdaParam::Primary,
                                CATSLambdaParam::Primary),
          ppLam4.GetLambdaParam(CATSLambdaParam::Primary,
                                CATSLambdaParam::Primary),
          ppLam5.GetLambdaParam(CATSLambdaParam::Primary,
                                CATSLambdaParam::Primary),
          ppLam6.GetLambdaParam(CATSLambdaParam::Primary,
                                CATSLambdaParam::Primary),
          ppLam7.GetLambdaParam(CATSLambdaParam::Primary,
                                CATSLambdaParam::Primary),
          ppLam8.GetLambdaParam(CATSLambdaParam::Primary,
                                CATSLambdaParam::Primary), };
  const std::vector<double> lam_pp_pL =
      { ppLam0.GetLambdaParam(CATSLambdaParam::Primary,
          ...
          CATSLambdaParam::Primary, CATSLambdaParam::FeedDown, 0, 0), ppLam3
          .GetLambdaParam(CATSLambdaParam::Primary, CATSLambdaParam::FeedDown,
                          0, 0), ppLam4.GetLambdaParam(
          CATSLambdaParam::Primary, CATSLambdaParam::FeedDown, 0, 0), ppLam5
          .GetLambdaParam(CATSLambdaParam::Primary, CATSLambdaParam::FeedDown,
                          0, 0), ppLam6.GetLambdaParam(
          CATSLambdaParam::Primary, CATSLambdaParam::FeedDown, 0, 0), ppLam7
          .GetLambdaParam(CATSLambdaParam::Primary, CATSLambdaParam::FeedDown,
                          0, 0), ppLam8.GetLambdaParam(
  ...
  const std::vector<double> lam_pp_fake =
      {
          (ppLam0.GetLambdaParam(CATSLambdaParam::Primary,
              ...
              + ppLam2.GetLambdaParam(CATSLambdaParam::Fake,
                                      CATSLambdaParam::Primary)
              + ppLam2.GetLambdaParam(CATSLambdaParam::Fake,
                                      CATSLambdaParam::Fake)), (ppLam3
              .GetLambdaParam(CATSLambdaParam::Primary, CATSLambdaParam::Fake)
              + ppLam3.GetLambdaParam(CATSLambdaParam::Fake,
                                      CATSLambdaParam::Primary)
              + ppLam3.GetLambdaParam(CATSLambdaParam::Fake,
                                      CATSLambdaParam::Fake)), (ppLam4
              .GetLambdaParam(CATSLambdaParam::Primary, CATSLambdaParam::Fake)
              + ppLam4.GetLambdaParam(CATSLambdaParam::Fake,
                                      CATSLambdaParam::Primary)
              + ppLam4.GetLambdaParam(CATSLambdaParam::Fake,
                                      CATSLambdaParam::Fake)), (ppLam5
              .GetLambdaParam(CATSLambdaParam::Primary, CATSLambdaParam::Fake)
              + ppLam5.GetLambdaParam(CATSLambdaParam::Fake,
                                      CATSLambdaParam::Primary)
              + ppLam5.GetLambdaParam(CATSLambdaParam::Fake,
                                      CATSLambdaParam::Fake)), (ppLam6
              .GetLambdaParam(CATSLambdaParam::Primary, CATSLambdaParam::Fake)
              + ppLam6.GetLambdaParam(CATSLambdaParam::Fake,
                                      CATSLambdaParam::Primary)
              + ppLam6.GetLambdaParam(CATSLambdaParam::Fake,
                                      CATSLambdaParam::Fake)), (ppLam7
              .GetLambdaParam(CATSLambdaParam::Primary, CATSLambdaParam::Fake)
              + ppLam7.GetLambdaParam(CATSLambdaParam::Fake,
                                      CATSLambdaParam::Primary)
              + ppLam7.GetLambdaParam(CATSLambdaParam::Fake,
                                      CATSLambdaParam::Fake)), (ppLam8
              .GetLambdaParam(CATSLambdaParam::Primary, CATSLambdaParam::Fake)
              + ppLam8.GetLambdaParam(CATSLambdaParam::Fake,
                                      CATSLambdaParam::Primary)
              + ppLam8.GetLambdaParam(CATSLambdaParam::Fake,
                                      CATSLambdaParam::Fake)) };
  ...
  std::vector<float> pSigma0Radii = { 1.55, 1.473, 1.421, 1.368, 1.295, 1.220,
      1.124 };
...
//  outTree->Branch("iRange",&iRange,"iRange/i");
  ...
  std::cout << "Resonance configuration: \n Resonance Proton Mass = "
      ...
      << " \n Resonance Lambda Mass = " << massLambdaRes << " and Width = "
      << widthLambdaRes << std::endl;
  ...
  for (vMod_pL = 0; vMod_pL < 2; ++vMod_pL) {
    ...
    if (vMod_pL == 0) {
      ...
      tidy->GetCatsProtonLambda(&AB_pL, NumMomBins, kMin, kMax, FeeddownSource,
                                TidyCats::pLOWF);
      std::cout << "Hi look again here" << std::endl;
