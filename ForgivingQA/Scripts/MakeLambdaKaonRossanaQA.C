...
int main(int argc, char* argv[]) {
  ...
  //Kaons
  auto dirTracks = file->GetDirectory(Form("%sPosKaonCuts%s", prefix, addon));
  TList *listTracks;
  dirTracks->GetObject(Form("%sPosKaonCuts%s", prefix, addon), listTracks);
  ...
  auto dirAntiTracks = file->GetDirectory(Form("%sNegKaonCuts%s", prefix, addon));
  TList *listAntiTracks;
  dirAntiTracks->GetObject(Form("%sNegKaonCuts%s", prefix, addon), listAntiTracks);
